...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        checkOutPage.enterFirstName("Krupali");
        checkOutPage.enterLastName("Lalkia");
        checkOutPage.enterEmail("krupali@gmail.com");
        checkOutPage.enterPhoneNumber("07888888888");
        checkOutPage.enterAddress1("15 Covent Garden");
        checkOutPage.enterCity("London");
        checkOutPage.enterComments("SL2 7TX");
        checkOutPage.selectCountry("UK");
        checkOutPage.selectRegion("West London");
